...
但是证据从来没有出现过。欧几里德定理层次从来没有建立。而程序员从来没有看到通过正式证明每一个小函数正确的艰辛过程的好处。最终，Dijkstra的梦想消失了，终于消失了。今天的程序员很少有人相信正式的证明是生产高质量软件的恰当方式。当然，正式的欧式风格的数学证明并不是证明某件事情正确的唯一策略。另一个非常成功的策略是科学的方法。
...
[^1]: 模因，参考[https://baike.baidu.com/item/meme/5265711](https://baike.baidu.com/item/meme/5265711)
